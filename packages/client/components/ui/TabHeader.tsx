...
const TabHeader = ({ header, isSelected, onClick }: Props) => {
    ...
    return (
        <div
            className='flex items-center justify-center border border-white 2xs:px-5 2xs:py-3 sm:py-4 sm:px-8 mt-4 rounded-md cursor-pointer shadow-md transition-all'
            style={hoverStyles}
            onClick={onClick}
