...
<<<<<<< HEAD
            <h1 className='text-black text-center mt-14 xl:mt-0 font-semibold md:text-[40px] text-[30px] capitalize'>
                Ethereum Slots
            </h1>
            ...
            >
                ...
                >
=======
            <h1 className='text-black text-center mt-14 xl:mt-0 font-semibold md:text-[40px] text-[30px] capitalize' style={{
                        color: themeMode?.darkMode ? 'var(--white)' : 'var(--black)'
                    }}>Ethereum Slots</h1>
